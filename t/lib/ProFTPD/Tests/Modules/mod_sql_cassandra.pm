...
my $TESTS = {
  ...
  sql_cassandra_protocol_v1 => {
    order => ++$order,
    test_class => [qw(forking)],
  },

  sql_cassandra_protocol_v2 => {
    order => ++$order,
    test_class => [qw(forking)],
  },

  sql_cassandra_protocol_v3 => {
    order => ++$order,
    test_class => [qw(forking)],
  },

  sql_cassandra_protocol_v4 => {
    order => ++$order,
    test_class => [qw(forking)],
  },

  sql_cassandra_protocol_v5 => {
    order => ++$order,
    test_class => [qw(forking)],
  },
